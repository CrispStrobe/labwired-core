...
fn main() {
    ...
    // The vendor C is portable: host gates compile it with the host compiler,
    // the firmware build uses cc's thumbv7em -> arm-none-eabi mapping.
    let target = env::var("TARGET").unwrap_or_default();
    let mut build = cc::Build::new();
    build
        .file("../../third_party/segger-rtt/SEGGER_RTT.c")
        .file("../../third_party/segger-rtt/SEGGER_RTT_printf.c")
    ...
    println!("cargo:rerun-if-changed=../../third_party/segger-rtt/SEGGER_RTT_printf.c");
