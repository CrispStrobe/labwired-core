...
/// miss — interprets one instruction, and a latching SCB reset or a DHCSR
/// halt ends the window on the instruction that latched it. A core that is
/// already halted does not enter the window.
///
