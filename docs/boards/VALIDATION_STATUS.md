...
| `esp32s3` | 🟢 silicon-verified | 2026-08-09 | `f58b6353e0b8df17` | ⚠ drift acked 2026-09-23, expires 2026-10-23 (re-capture pending) |
| `esp32s3-zero` | 🔵 sim-validated (deep model, no HW diff) | — | `4f743b3c23dea783` | no silicon capture |
...
| `esp32` | ⚪ structural | — | `78df98f67e5de831` | no silicon capture |
