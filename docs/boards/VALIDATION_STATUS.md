...
| `esp32s3` | 🟢 silicon-verified | 2026-08-09 | `4c056030873b6c4f` | ⚠ drift acked 2026-09-23, expires 2026-10-23 (re-capture pending) |
| `esp32s3-zero` | 🔵 sim-validated (deep model, no HW diff) | — | `98df63c1f4e81b41` | no silicon capture |
...
| `esp32` | ⚪ structural | — | `28aeaafd9e01b8ea` | no silicon capture |
