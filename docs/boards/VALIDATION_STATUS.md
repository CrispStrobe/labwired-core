...
| `esp32s3` | 🟢 silicon-verified | 2026-08-09 | `aba3348261c4f054` | ⚠ drift acked 2026-09-23, expires 2026-10-23 (re-capture pending) |
| `esp32s3-zero` | 🔵 sim-validated (deep model, no HW diff) | — | `08df3dd60fcd7d7e` | no silicon capture |
...
| `esp32` | ⚪ structural | — | `c1e0ae083c2417b2` | no silicon capture |
