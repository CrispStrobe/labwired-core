...
| `esp32s3` | 🟢 silicon-verified | 2026-08-09 | `2880e7e6266b3cdd` | ⚠ drift acked 2026-09-23, expires 2026-10-23 (re-capture pending) |
| `esp32s3-zero` | 🔵 sim-validated (deep model, no HW diff) | — | `153f90b61c4b7ca2` | no silicon capture |
...
| `esp32` | ⚪ structural | — | `09cb202abb486c30` | no silicon capture |
