...
`SEGGER_RTT.c` / `SEGGER_RTT.h` / `SEGGER_RTT_printf.c` are unmodified copies
from the Zephyr segger module (west `modules/debug/segger`, SystemView 3.40
tree).
...
- SEGGER_RTT_printf.c sha256: 436e188709d144e9e4280ceaf68e57abdd6006b9b3bfb995d39a85982e254b58
